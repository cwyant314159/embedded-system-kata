...
static volatile IsrCallback_t timer0_callback = NULL;
static volatile IsrCallback_t timer1_callback = NULL;
static volatile IsrCallback_t timer2_callback = NULL;
